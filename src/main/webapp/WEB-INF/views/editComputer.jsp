            ...
            <div class="row">
                <div class="col-xs-8 col-xs-offset-2 box">
                    <div class="label label-default pull-right">
                        id: ${ requestScope.computerId }
                    </div>
                    <h1><spring:message code="label.editComputer"></spring:message></h1>

                    <form action="editComputer" method="POST">
                        <input type="hidden" value="${ requestScope.computerId }" id="id" name="id"/> <!-- TODO: Change this value with the computer id -->
                        <fieldset>
                            <div class="form-group">
                                <label for="computerName"><spring:message code="label.computerName"></spring:message></label>
                                <input type="text" class="form-control" id="computerName" name="computerName" required="required" placeholder=<spring:message code= "label.computerName"></spring:message>>
                            </div>
                            <div class="form-group">
